...
public class CustomersProfile {
    ...
    private String name, phone, email ,address,shortdescription,imageUrl;

    public CustomersProfile() {
        //Constructor , it is needed
    }

    public CustomersProfile(String name, String phone, String email, String address,String shortdescription, String imageUrl) {
        this.phone = phone;
